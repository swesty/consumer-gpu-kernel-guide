...
Tests Qwen3-8B specific shapes on NVIDIA GB10 (DGX Spark):
...
def main():
    parser = argparse.ArgumentParser(description="Benchmark RMSNorm for Qwen3-8B on GB10")
    ...
    # GB10 theoretical peak bandwidth: 273 GB/s (LPDDR5X)
    PEAK_BW_GBS = 273
